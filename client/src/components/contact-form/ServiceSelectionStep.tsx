...
export const ServiceSelectionStep = ({
    ...
    return (
        ...
        >
            ...
            <div className="border border-border dark:border-border rounded-2xl p-4 md:p-6 bg-secondary/50 dark:bg-card/50 transition-colors">
                ...
                `}
                    ...
                    ${isSelected ? 'bg-gradient-to-br from-primary to-accent text-primary-foreground shadow-md scale-110' : 'bg-secondary dark:bg-secondary text-muted-foreground dark:text-muted-foreground group-hover:bg-primary/10 dark:group-hover:bg-primary/20 group-hover:text-primary dark:group-hover:text-primary'}
                  `}>
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex justify-between items-start w-full mb-1">
                                            <h4 className={`text-base font-semibold transition-colors break-words hyphens-auto ${isSelected ? 'text-primary dark:text-primary' : 'text-foreground dark:text-foreground'}`}>
                                                {service.title}
                                            </h4>
                        ...
                        ${isSelected
                                                    ...
                                                    : 'border-input dark:border-input opacity-0 scale-90'
                                                }
                      `}>
                                        ...
                                        {/* Description */}
                                        {service.description && (
                                            <p className="text-sm text-muted-foreground dark:text-muted-foreground leading-relaxed mb-2 transition-colors">
                                                {service.description}
                                            </p>
                                        )}
                                        ...
                                        {service.isBundle && t.relocationBundleItems && (
                                            <ul className="mt-3 space-y-1.5 bg-card/50 dark:bg-card/50 rounded-lg p-3 border border-primary/10 dark:border-primary/10 transition-colors">
                                                <p className="text-xs font-semibold text-primary dark:text-primary uppercase tracking-wider mb-2">Included:</p>
                                                {t.relocationBundleItems.map((item, i) => (
                                                    <li key={i} className="flex items-start gap-2 text-sm text-muted-foreground dark:text-muted-foreground">
