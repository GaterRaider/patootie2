...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "focus:bg-indigo-50 dark:focus:bg-indigo-900/50 focus:text-indigo-900 dark:focus:text-indigo-100 [&_svg:not([class*='text-'])]:text-indigo-600 dark:[&_svg:not([class*='text-'])]:text-indigo-400 relative flex w-full cursor-default items-center gap-2 rounded-sm py-1.5 pr-8 pl-2 text-sm outline-hidden select-none whitespace-normal data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2",
        className
      )}
      {...props}
    >
