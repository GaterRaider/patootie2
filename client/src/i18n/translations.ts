...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    heroDescription: "German bureaucracy can be overwhelming, especially when you're not in the country. Kwon EasyBureau assists with immigration matters, official certificates, paperwork, pension requests, and any task that requires someone in Germany to handle the process for you.",
    ...
    serviceCard1FullDesc: "Navigating the Ausl\u00e4nderbeh\u00f6rde can be confusing\u2014Kwon EasyBureau assists with applications, documents, translations, and scheduling appointments on your behalf.",
    ...
    serviceCard2FullDesc: "Many forms require detailed information, strict formatting, or confirmation from inside Germany. Kwon EasyBureau helps you complete, submit, and track your official paperwork.",
    ...
    serviceCard3FullDesc: "Kwon EasyBureau helps collect the correct documents, communicate with German offices, and ensure payments are processed correctly\u2014especially useful for former workers who moved abroad.",
    ...
    serviceCard4FullDesc: "Whether it's a certificate, a complicated document request, or something unusual you cannot do from abroad\u2014Kwon EasyBureau can handle most German bureaucratic matters.",
    ...
    processStep2Desc: "Kwon EasyBureau reviews your situation and contacts you.",
    processStep3Title: "Start working together",
    processStep3Desc: "After agreement on fees, Kwon EasyBureau assists with your case.",
    processNote: "Note: submitting the form does not create a binding contract; Kwon EasyBureau will first provide an offer.",
    ...
    // About Section
    aboutHeading: "About Kwon EasyBureau",
    aboutParagraph1: "Kwon EasyBureau is experienced in dealing with German authorities and understands the complexities of German bureaucracy. With years of experience navigating the system, Kwon EasyBureau provides personalized assistance to make your journey smoother.",
    aboutParagraph2: "Whether you are an immigrant, a foreign resident in Germany, or someone living abroad who needs to interact with German authorities, Kwon EasyBureau can help. From visa applications to pension claims, every case receives dedicated attention and professional guidance.",
    aboutParagraph3: "Kwon EasyBureau specializes in helping individuals abroad obtain German pension payments and other social benefits, ensuring that distance is never a barrier to accessing what you're entitled to.",
    aboutLanguages: "Languages spoken: English, Korean, German",

    // Footer
    footerAboutTitle: "About Kwon EasyBureau",
  ...
  ko: {
    ...
    heroDescription: "독일 관료주의는 특히 현지에 있지 않을 때 부담스러울 수 있습니다. Kwon EasyBureau는 이민 문제, 공식 증명서, 서류 작업, 연금 신청, 그리고 독일 현지에서 누군가가 처리해야 하는 모든 업무를 도와드립니다.",
    ...
    serviceCard1FullDesc: "외국인청(Ausl\u00e4nderbeh\u00f6rde) 업무는 복잡할 수 있습니다. Kwon EasyBureau가 신청서, 서류, 번역 및 예약 일정을 대신 도와드립니다.",
    ...
    serviceCard2FullDesc: "많은 양식은 상세한 정보, 엄격한 형식 또는 독일 내 확인이 필요합니다. Kwon EasyBureau가 공식 서류 작성, 제출 및 추적을 도와드립니다.",
    ...
    serviceCard3FullDesc: "Kwon EasyBureau가 올바른 서류 수집, 독일 관공서와의 소통, 지급 처리를 도와드립니다. 특히 해외로 이주한 전직 근로자에게 유용합니다.",
    ...
    serviceCard4FullDesc: "증명서, 복잡한 서류 요청 또는 해외에서 처리할 수 없는 특이한 상황이든, Kwon EasyBureau가 대부분의 독일 관료 업무를 처리할 수 있습니다.",
    ...
    processStep2Desc: "Kwon EasyBureau가 상황을 검토하고 연락드립니다.",
    processStep3Title: "협력 시작",
    processStep3Desc: "비용 합의 후 Kwon EasyBureau가 귀하의 사례를 지원합니다.",
    processNote: "참고: 양식 제출이 구속력 있는 계약을 생성하지 않습니다. Kwon EasyBureau가 먼저 견적을 제공합니다.",
    ...
    // About Section
    aboutHeading: "Kwon EasyBureau 소개",
    aboutParagraph1: "Kwon EasyBureau는 독일 관공서 업무에 대한 경험이 풍부하며 독일 관료제의 복잡성을 이해하고 있습니다. 수년간의 시스템 탐색 경험을 바탕으로 귀하의 여정을 더 원활하게 만들어드립니다.",
    aboutParagraph2: "이민자, 독일 거주 외국인 또는 독일 관공서와 소통해야 하는 해외 거주자 모두를 도와드립니다. 비자 신청부터 연금 청구까지 모든 사례에 전담 지원과 전문적인 안내를 제공합니다.",
    aboutParagraph3: "Kwon EasyBureau는 해외 거주자가 독일 연금 및 기타 사회 복지를 받을 수 있도록 전문적으로 지원하며, 거리가 귀하의 권리를 받는 데 장애가 되지 않도록 합니다.",
    aboutLanguages: "사용 언어: 영어, 한국어, 독일어",

    // Footer
    footerAboutTitle: "Kwon EasyBureau 소개",
